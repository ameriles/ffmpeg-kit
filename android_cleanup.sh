...
echo "  ./android.sh --enable-dav1d --enable-kvazaar --enable-openh264 --enable-libvpx --enable-libwebp --enable-snappy --enable-zimg --enable-android-media-codec --disable-arm-v7a-neon --disable-x86 --disable-x86-64"
