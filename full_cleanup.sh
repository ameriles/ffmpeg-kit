...
echo ""
echo "To build both platforms (recommended):"
echo "  ./benchmark_build.sh --video"
echo ""
echo "To measure iOS build time:"
echo "  time ./ios.sh --enable-dav1d --enable-kvazaar --enable-openh264 --enable-libvpx --enable-libwebp --enable-snappy --enable-zimg --enable-ios-videotoolbox --disable-arm64-simulator --disable-arm64e --disable-i386 --disable-x86-64 --disable-x86-64-mac-catalyst --disable-arm64-mac-catalyst"
echo ""
...
echo "  time ./android.sh --enable-dav1d --enable-kvazaar --enable-openh264 --enable-libvpx --enable-libwebp --enable-snappy --enable-zimg --enable-android-media-codec --disable-arm-v7a-neon --disable-x86 --disable-x86-64"
